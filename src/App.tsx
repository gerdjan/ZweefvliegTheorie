...
export default function App(){
  ...
  return <main className="app">
    ...
    <div className="layout">
      <section><h2 className="small-title">De 9 examenvakken</h2><p className="muted">Beginselen van het zweefvliegen en Meteorologie zijn volledige 1.0-cursussen met broncontrole, kenniselementen, hoofdstuktoetsen, herhaling en vakexamen. De overige vakken volgen dezelfde strikte pipeline.</p><SubjectList subjects={subjects} currentId={subject.id} onSelect={next=>{setSubject(next);setResultState(null)}} completedLessons={progress.completedLessons}/></section>
