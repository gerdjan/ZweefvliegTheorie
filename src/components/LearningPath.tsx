  ...
  return <section className="card path-card">
    ...
    {subject.id==='principles' && <>
      <div className="source-policy-banner">
        ...
        <span><strong>Dekkingsstatus:</strong> 42/42 genummerde bronsecties aanwezig · 231/294 afzonderlijke auditpunten expliciet afgedekt (78,6%). §5.0, §5.1 en §5.2 zijn detail-audited; §5.3 t/m §5.7 volgen.</span>
      </div>
