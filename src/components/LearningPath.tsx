  ...
  return <section className="card path-card">
    ...
    {subject.id==='principles' && <>
      <div className="source-policy-banner">
        ...
        <span><strong>Dekkingsstatus:</strong> 42/42 genummerde bronsecties aanwezig · 240/294 afzonderlijke auditpunten expliciet afgedekt (81,6%). §5.0 t/m §5.3 zijn detail-audited; §5.4 t/m §5.7 volgen.</span>
      </div>
