...
export const principlesSubject:SourcedSubject = {
  ...
  sourceFreshness:'38 levels · theorie november 2025 · detailaudit 81,6%',
  description:'38 levels over aerodynamica, vliegmechanica, stabiliteit, besturing, belastingen, overtrek, tolvlucht en spiraalduik. Elk theorieblok en elke vraag heeft een controleerbare PDF-bron. 5.0 t/m 5.3 zijn nu pagina-voor-pagina op detailniveau gecontroleerd; 5.4 t/m 5.7 volgen.',
  units:[...basics,...completenessA,...aeroA,...density,...aeroB,...completenessB,...mechanics,...mechanicsCompleteness,...stabilityControls,...stabilityCompleteness,...limits,...safetyFinal],
}
