...
export const meteorologyKnowledge:KnowledgeChapter[]=meteorologyChapters.map(chapter=>{
  const units=meteorologySubject.units.filter(unit=>unit.title.startsWith(chapter.id))
